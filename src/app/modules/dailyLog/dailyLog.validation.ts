    ...
    .object({
      ...
      dailyWellnessQuestionnaire: z
        .object({
          ...
          soreness: z.number().min(1).max(10, "Scale must be between 1-10").optional(),
          ...
          hydrationLevel: z.number().min(1).max(10, "Scale must be between 1-10").optional(),
          readinessToCompete: z.number().min(1).max(10, "Scale must be between 1-10").optional(),
        })
        .optional(),
      throwingJournal: z
        .object({
      ...
      armCare: z
        .object({
          focus: z.array(z.enum(["Scapular", "Shoulder", "Forearms", "Biceps/Triceps"])).optional(),
          exerciseType: z.enum(["Isometric", "Eccentric", "Oscillating"]).optional(),
      ...
      Lifting: z
        .object({
          type: z.array(z.enum(["Upper Body", "Total Body", "Speed & Agility", "Lower Body", "Plyometrics"])).optional(),
          focus: z.array(z.enum(["Speed", "Eccentric", "Isometric", "Concentric"])).optional(),
          exercisesLog: z.string().optional(),
        })
        .optional(),
      hittingJournal: z
        .object({
          pregameEngagement: z.number().min(1).max(10, "Scale must be between 1-10").optional(),
      ...
      postPerformance: z
        .object({
          gameRating: z.number().min(1).max(10, "Scale must be between 1-10").optional(),
